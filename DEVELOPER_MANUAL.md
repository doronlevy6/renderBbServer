...
- `bb-db`
- `pgadmin`
- טרמינל גלוי ל־backend
- טרמינל גלוי ל־frontend
...
- כל אחד נפתח בטרמינל גלוי ב־`Terminal.app`, עם לוגים חיים כאילו הרצת ידנית.
- הטרמינל של ה־Task ב־VS Code מציג רק את שלב ההכנה והסטטוס.
