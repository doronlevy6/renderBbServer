...
write_stopped_mode_files() {
  local frontend_api_mode="$1"
  local backend_db_mode="$2"
  local frontend_app_env="$3"
  local backend_env_name="$4"
...
// Do not edit manually.
const String kRuntimeServiceStatus = 'stopped';
...
main() {
  ...
  write_stopped_mode_files "${frontend_api_mode}" "${backend_db_mode}" "${frontend_app_env}" "${backend_env_name}"
  log "Done. Development environment stopped."
}
